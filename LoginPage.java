...
class LoginPage extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==loginButton1) 
		{
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/insurance","root","akhil");
			Statement stmt=con.createStatement();
			String sql="Select * from userdata where name='"+userTextField.getText()+"' and password='"+passPasswordField.getText().toString()+"'";
